...
# Seed Dosages
Dosage.create(medication: atorvastatin, dosage_amount: '2.5 mg', frequency: 'once_daily', default_duration: 14)
Dosage.create(medication: atorvastatin, dosage_amount: '5 mg', frequency: 'twice_daily', default_duration: 7)
Dosage.create(medication: metformin, dosage_amount: '500 mg', frequency: 'once_daily', default_duration: 30)
Dosage.create(medication: panadol, dosage_amount: '500 mg', frequency: 'once_week', default_duration: 21)
Dosage.create(medication: panadol, dosage_amount: '600 mg', frequency: 'once_week', default_duration: 21)
Dosage.create(medication: evion, dosage_amount: '250 mg', frequency: 'twice_week', default_duration: 30)
